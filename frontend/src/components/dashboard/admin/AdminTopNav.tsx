...
export default function AdminTopNav({ onToggle }: Props) {
      ...
      <div className="flex items-center justify-between px-6 py-4">
        <div className="flex items-center gap-3">
          <button
            type="button"
            onClick={onToggle}
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-700 bg-gray-900/80 text-gray-200 transition-all duration-200 hover:border-emerald-500/30 hover:bg-gray-800 hover:text-white active:scale-95 cursor-pointer"

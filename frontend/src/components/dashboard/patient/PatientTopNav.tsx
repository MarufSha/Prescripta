...
export default function PatientTopNav({ onToggle }: Props) {
      ...
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-2">
          <button
            type="button"
            onClick={toggleTheme}
            className="inline-flex h-10 w-10 items-center justify-center rounded-xl border border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900/80 transition-all duration-200 hover:border-blue-500/30 hover:bg-gray-100 dark:hover:bg-gray-800 active:scale-95 cursor-pointer"
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button
                type="button"
                className="flex h-10 w-10 items-center justify-center rounded-2xl border border-blue-500/20 bg-blue-500/10 cursor-pointer hover:bg-blue-500/20 transition-colors"
